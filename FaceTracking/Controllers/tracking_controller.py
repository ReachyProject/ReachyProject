...
class WaveDetector:
    ...
    def _smooth_positions(self, positions, window=3):
    ...
    def _analyze_wave_motion(self):
        ...
        smoothed_positions = self._smooth_positions(positions, self.smoothing_window)
        ...
        # Detect direction changes in horizontal movement with threshold
        direction_changes = 0
...
class TrackingController:
    ...
    def __init__(self, camera_source, show_overlay=True):
        ...
        if self.is_reachy_camera:
            # Will be set later when reachy object is provided
